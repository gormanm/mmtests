...
use constant stat_names => {
	...
	"percentile-90" => "Pct.90",
	"percentile-95" => "Pct.95",
	"percentile-99" => "Pct.99",
	"percentile-99.9" => "Pct.99.9",
	"percentile-99.99" => "Pct.99.99",
	"percentile-99.999" => "Pct.99.999",
	"percentile-99.9999" => "Pct.99.9999",
	"percentile-99.99999" => "Pct.99.99999",
	"percentile-"	=> "Pct.%d",
	"percentileci_low-"	=> "Pct.%d-CI-Low",
	"percentileci_high-"	=> "Pct.%d-CI-High",
	"samples"	=> "Samples",
	"samples-"	=> "Samples-[%s)",
