...
use constant stat_names => {
	...
	"percentile-99.9" => "Pctile.99.9",
	"percentile-99.99" => "Pctile.99.99",
	"percentile-99.999" => "Pctile.99.999",
	"percentile-99.9999" => "Pctile.99.9999",
	"percentile-99.99999" => "Pctile.99.99999",
	"percentile-"	=> "Pctile.%d",
	"percentileci_low-"	=> "Pctile.%d-CI-Low",
	"percentileci_high-"	=> "Pctile.%d-CI-High",
	"samples"	=> "Samples",
	"samples-"	=> "Samples-[%s)",
