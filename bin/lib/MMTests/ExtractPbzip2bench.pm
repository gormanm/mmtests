# ExtractPbzip2bench.pm
package MMTests::ExtractPbzip2bench;
...
sub initialise() {
	...
	$self->{_ModuleName} = "ExtractPbzip2bench";
...
sub extractReport($$$) {
	...
	my @files = <$reportDir/noprofile/pbzip2bench-*-1.time>;
	...
	foreach my $nthr (@threads) {
		my @files = <$reportDir/noprofile/pbzip2bench-$nthr-*.time>;
