...
for SUBREPORT in kernbench tiobench dbench3 dbench4 multibuild fsmark postmark iozone netperf-udp netperf-tcp tbench4 hackbench-pipes hackbench-sockets vmr-createdelete vmr-cacheeffects ffsb vmr-aim9 vmr-stream sysbench largecopy largedd simple-writeback rsyncresidency ddresidency stress-highalloc thpavail pft micro; do
