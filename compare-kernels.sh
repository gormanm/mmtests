...
for SUBREPORT in kernbench multibuild fsmark postmark iozone netperf-udp netperf-tcp hackbench-pipes hackbench-sockets vmr-createdelete vmr-cacheeffects vmr-aim9 vmr-stream sysbench largecopy largedd simple-writeback rsyncresidency stress-highalloc micro; do
